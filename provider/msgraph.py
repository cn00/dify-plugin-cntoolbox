...
class MSGraphProvider(ToolProvider):
    def _validate_credentials(self, credentials: dict[str, Any]) -> None:
        ...
        try:
            ...
            """
            required_keys = ["MICROSOFT_GRAPH_USERNAME", "MICROSOFT_GRAPH_CLIENTID", "MICROSOFT_GRAPH_CLIENTSECRET", "MICROSOFT_GRAPH_TEST_EMAIL"]
            ...
            asyncio.run(api.sendMail(to=[test_email], subject='Test Email', content_type=BodyType.TEXT, content='Hello from Dify msgraph plugin'))
